...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('designation', trans('quickadmin.teacher.fields.designation').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('password', trans('quickadmin.teacher.fields.password').'*', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    @if ($teacher->photo)
                        <a href="{{ asset(env('UPLOAD_PATH').'/'.$teacher->photo) }}" target="_blank"><img src="{{ asset(env('UPLOAD_PATH').'/thumb/'.$teacher->photo) }}"></a>
                    @endif
                    {!! Form::label('photo', trans('quickadmin.teacher.fields.photo').'', ['class' => 'control-label']) !!}
                    {!! Form::hidden('photo', old('photo')) !!}
                    {!! Form::file('photo', ['class' => 'form-control', 'style' => 'margin-top: 4px;']) !!}
                    {!! Form::hidden('photo_max_size', 1) !!}
